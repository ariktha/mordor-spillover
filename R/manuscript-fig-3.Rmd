...
rings_map <- ggplot() + 
  ...
  guides(color = "none") + 
  annotate("text", x = 3.16, y = 13.12, label = "NOT\nREAL\nDATA",
             hjust = 0.5, vjust = 0.5, col = "grey", cex = 20,
...
rings_grappes_plot <- ggplot(subset(morb_rings, outer_radius <= 30)) +
  ...
  annotate("text", x = Inf, y = 2, label = "NOT REAL DATA",
             hjust = 1, vjust = 1, col = "grey", cex = 6,
...
rings_corr_plot <- 
  ...
  annotate("text", x = 15000, y = 75, label = "NOT\nREAL\nDATA",
