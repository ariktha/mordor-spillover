...
if(run_public){
  morb_grappe_names <- c("community-1", "community-2", "community-3", "community-4")
} else {
...
rings_map <- ggplot() + 
  ...
  guides(color = "none") + 
  annotate("text", x = 3.16, y = 13.12, label = watermark_text_ml,
             hjust = 0.5, vjust = 0.5, col = watermark_color, cex = 20,
             fontface = "bold", alpha = 0.5) 

rings_map

ggsave(rings_map, filename = here("output", "figs-manuscript", "fig3-panelA.png"), 
...
rings_grappes_plot <- ggplot(subset(morb_rings, outer_radius <= 30)) +
  ...
  annotate("text", x = Inf, y = 2, label = watermark_text,
             hjust = 1, vjust = 1, col = watermark_color, cex = 6,
             fontface = "bold", alpha = 0.5, angle = 0)

rings_grappes_plot

ggsave(rings_grappes_plot, filename = here("output", "figs-manuscript", "fig3-panelB.png"), 
       width = 6, height = 4.5, dpi = 600, bg = "white")
```
...
rings_corr_plot <- 
  ...
  annotate("text", x = 15000, y = 75, label = watermark_text_ml,
             hjust = 0.5, vjust = 0.5, col = watermark_color, cex = 12,
             fontface = "bold", alpha = 0.5, angle = 0)

rings_corr_plot

ggsave(rings_corr_plot, filename = here("output", "figs-manuscript", "fig3-panelC.png"), 
       width = 6, height = 4.5, dpi = 600, bg = "white")
```
...
ggsave(fig3_plot, filename = here("output", "figs-manuscript", "fig3.png"), width = 9, height = 9)
