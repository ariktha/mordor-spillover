...
ggplot(data = cor_tx_int_pwr2, aes(group = arm, color = arm)) +
  ...
  annotate("text", x = 0.5, y = 75, label = "NOT\nREAL\nDATA",
...
ggplot() + geom_boxplot(data = loo_cor,
  ...
  annotate("text", x = 1.5, y = 0.25, label = "NOT\nREAL\nDATA",
             hjust = 0.5, vjust = 0.5, col = "grey", cex = 12,
             fontface = "bold", alpha = 0.5)
...
azithro_doses_plot <- ggplot(data = dat_fig3, 
  ...
  annotate("text", x = 10, y = 15, label = "NOT\nREAL\nDATA",
...
azithro_txint_plot <- ggplot(data = dat_fig3, aes(x = total_children / 1000, y = tx_int)) + 
  ...
  annotate("text", x = 10, y = 0.5, label = "NOT\nREAL\nDATA",
             hjust = 0.5, vjust = 0.5, col = "grey", cex = 8,
             fontface = "bold", alpha = 0.5)
...
p1 <- ggplot(morb_pop,
  ...
  annotate("text", x = 20, y = 15000, label = "NOT\nREAL\nDATA",
             hjust = 0.5, vjust = 0.5, col = "grey", cex = 10,
             fontface = "bold", alpha = 0.5)
...
p2 <- ggplot(morb_pop, aes(
  ...
  theme(legend.position = "bottom",
        panel.spacing.x = unit(0.6, "cm")) +
  ylim(c(0, 200))  + 
  annotate("text", x = 20, y = 100, label = "NOT\nREAL\nDATA",
             hjust = 0.5, vjust = 0.5, col = "grey", cex = 8,
             fontface = "bold", alpha = 0.5)
...
q1 <- ggplot(morb_csi, aes(y = tx_int, x = dist_csi, color = arm)) + 
  ...
  annotate("text", x = 3.8, y = 0.5, label = "NOT REAL DATA",
             hjust = 0.5, vjust = 0.5, col = "grey", cex = 16,
             fontface = "bold", alpha = 0.5)
...
q2 <- ggplot(morb_csi, aes(x = dist_csi, y = avg_res, color = arm)) + 
  ...
  annotate("text", x = 4, y = 65, label = "NOT\nREAL\nDATA",
             hjust = 0.5, vjust = 0.5, col = "grey", cex = 12,
             fontface = "bold", alpha = 0.5)
