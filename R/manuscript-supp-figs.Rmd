...
ggsave(here("figs", "manuscript", "supp-figs", "supp_fig6-with-p.png"), other_abs_plot_with_ps, bg = "white", width = 11, height = 9, dpi = 300)
...
ggsave(here("figs", "manuscript", "supp-figs", "supp_fig6.png"), other_abs_plots, bg = "white", width = 11, height = 9, dpi = 300)
