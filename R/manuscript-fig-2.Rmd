...
ggsave(baseline_pri, filename = here("output", "figs-manuscript", "fig2-panelA.png"), 
...
ggsave(baseline_nce, filename = here("output", "figs-manuscript", "fig2-panelC.png"), 
       width = 6, height = 4.5, dpi = 600, bg = "white")
```
...
ggsave(pri_24, filename = here("output", "figs-manuscript", "fig2-panelB.png"), 
       width = 6, height = 4.5, dpi = 600, bg = "white")
```
...
ggsave(nce_24, filename = here("output", "figs-manuscript", "fig2-panelD.png"), 
       width = 6, height = 4.5, dpi = 600, bg = "white")
```
...
ggsave(fig2_plot, filename = here("output", "figs-manuscript", "fig2.png"), 
