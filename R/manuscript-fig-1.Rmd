...
if(run_public){
  ...
  intl_boundaries_raw <- st_read(file.path(path_data_clean, "intl_boundaries", "adm0_polygons.gpkg"))
...
grid_tx_int_df <- readRDS(here("data", "output", "grid_tx_int_df.RDS"))
```
...
ggsave(
  niger_map,
  filename = here("output", "figs-manuscript", "fig1_panelA.png"),
  width = 6,
  height = 4,
  dpi = 300
)
...
all_grappes_plot <- ggplot() +
  ...
  annotate("text", x = 2.8, y = 13.115, label = watermark_text_ml,
             hjust = 0.5, vjust = 0.5, col = watermark_color, cex = 24,
             fontface = "bold", alpha = 0.5)  + 
  annotate("text", x = 3.52, y = 13.65, label = watermark_text_ml,
...
ggsave(
  all_grappes_plot,
  filename = here("output", "figs-manuscript", "fig1_panelB.png"),
  width = 6,
  height = 4,
  dpi = 300
)
...
ggsave(
  n_doses_plot,
  filename = here("output", "figs-manuscript", "fig1_panelC.png"),
  width = 6,
  height = 4,
  dpi = 300
)
...
ggsave(
  tx_int_layer_plot,
  filename = here("output", "figs-manuscript", "fig1_panelD.png"),
  width = 6,
  height = 4,
  dpi = 300
)
...
ggsave(
  fig1_plot,
  filename = here("output", "figs-manuscript", "fig1.png"),
  width = 10,
  height = 12,
  dpi = 300
)

knitr::include_graphics(here("output", "figs-manuscript", "fig1.png"))
