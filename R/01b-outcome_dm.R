...
amr_dat_long <- amr_dat %>% 
  pivot_longer(cols = ab_classes_of_interest, 
               names_to = "ab_class", 
...
saveRDS(amr_data_summ, here("data", "detailed", "amr_dat_full.RDS"))
saveRDS(amr_dat_final, here("data", "final", "amr_dat.RDS"))
saveRDS(mls_dat, here("data", "final", "mls_dat.RDS"))
